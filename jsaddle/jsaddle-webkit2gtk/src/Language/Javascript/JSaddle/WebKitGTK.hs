...
run main = do
    ...
    -- setSettingsEnableUniversalAccessFromFileUrls settings True
    setSettingsAllowFileAccessFromFileUrls settings True
    settingsSetAllowUniversalAccessFromFileUrls settings True
    setSettingsEnableDeveloperExtras settings True
    setSettingsEnableJavascript settings True
    setSettingsEnableWriteConsoleMessagesToStdout settings False
